# Generated by Django 3.2.9 on 2022-01-10 02:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='Solvent_conf',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.solvent_conf', verbose_name='溶剤単価'),
        ),
        migrations.AddField(
            model_name='machine_drive_history',
            name='Unit_price_electric',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.unit_price_electric', verbose_name='電力単価'),
        ),
        migrations.AddField(
            model_name='machine_drive_history',
            name='Unit_price_gas',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.unit_price_gas', verbose_name='ガス単価'),
        ),
        migrations.AddField(
            model_name='machine_drive_history',
            name='Unit_price_steam',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.unit_price_steam', verbose_name='蒸気単価'),
        ),
        migrations.AddField(
            model_name='machine_drive_history',
            name='Unit_price_water',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.unit_price_water', verbose_name='水単価'),
        ),
        migrations.AddField(
