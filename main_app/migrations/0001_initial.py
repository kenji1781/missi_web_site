# Generated by Django 3.2.9 on 2022-01-01 16:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Setting_item_id', models.IntegerField(blank=True, default=1, null=True, verbose_name='品種ID')),
                ('Setting_item_name', models.CharField(blank=True, max_length=20, null=True, verbose_name='品種名')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('Setting_item_id', 'Setting_item_name'), name='unique_setting_item'),
        ),
        migrations.AddConstraint(
