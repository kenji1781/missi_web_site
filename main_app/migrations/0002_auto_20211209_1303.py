# Generated by Django 3.2.8 on 2021-12-09 04:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Solvent_manu', models.CharField(blank=True, max_length=20, null=True, verbose_name='メーカー')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Solvent_name', models.CharField(blank=True, max_length=20, null=True, verbose_name='溶剤名')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='Customer_racipe_name',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.recipe_name', verbose_name='品種'),
        ),
        migrations.AddField(
