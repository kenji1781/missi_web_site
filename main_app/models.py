...
class Machine_Log(models.Model):
    Machine_model = models.ForeignKey(Customer_Machine,on_delete=CASCADE,verbose_name='装置')
    Machine_log_time0 = models.BigIntegerField(verbose_name='稼働時間0',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_time1 = models.BigIntegerField(verbose_name='稼働時間1',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_time2 = models.BigIntegerField(verbose_name='稼働時間2',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_time3 = models.BigIntegerField(verbose_name='稼働時間3',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_time4 = models.BigIntegerField(verbose_name='稼働時間4',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_time5 = models.BigIntegerField(verbose_name='稼働時間5',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_time6 = models.BigIntegerField(verbose_name='稼働時間6',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_time7 = models.BigIntegerField(verbose_name='稼働時間7',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_time8 = models.BigIntegerField(verbose_name='稼働時間8',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_time9 = models.BigIntegerField(verbose_name='稼働時間9',validators=[MinValueValidator(0)],default=0,blank=False,null=False)    
    Machine_log_count0 = models.BigIntegerField(verbose_name='稼働回数0',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_count1 = models.BigIntegerField(verbose_name='稼働回数1',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_count2 = models.BigIntegerField(verbose_name='稼働回数2',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_count3 = models.BigIntegerField(verbose_name='稼働回数3',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_count4 = models.BigIntegerField(verbose_name='稼働回数4',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_count5 = models.BigIntegerField(verbose_name='稼働回数5',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_count6 = models.BigIntegerField(verbose_name='稼働回数6',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_count7 = models.BigIntegerField(verbose_name='稼働回数7',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_count8 = models.BigIntegerField(verbose_name='稼働回数8',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Machine_log_count9 = models.BigIntegerField(verbose_name='稼働回数9',validators=[MinValueValidator(0)],default=0,blank=False,null=False)
    Data_datetime =  models.DateTimeField(verbose_name='データ取得日',blank=True,null=True)
    Data_date =  models.DateField(verbose_name='データ取得日（年月日）',blank=True,null=True)
    Data_time =  models.TimeField(verbose_name='データ取得日（時分秒）',blank=True,null=True)
