...
class Maintenance_Mail_Setting(models.Model):
    ...
    Maintenance_threshold = models.IntegerField(verbose_name='閾値:装置運転回数',validators=[MinValueValidator(1)],default=1,blank=True,null=True)
...
class Machine_Operating_Log(models.Model):
    Machine_model = models.ForeignKey(Customer_Machine,on_delete=CASCADE,verbose_name='装置')
    Machine_operate_time0 = models.BigIntegerField(verbose_name='稼働時間0',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_time1 = models.BigIntegerField(verbose_name='稼働時間1',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_time2 = models.BigIntegerField(verbose_name='稼働時間2',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_time3 = models.BigIntegerField(verbose_name='稼働時間3',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_time4 = models.BigIntegerField(verbose_name='稼働時間4',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_time5 = models.BigIntegerField(verbose_name='稼働時間5',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_time6 = models.BigIntegerField(verbose_name='稼働時間6',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_time7 = models.BigIntegerField(verbose_name='稼働時間7',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_time8 = models.BigIntegerField(verbose_name='稼働時間8',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_time9 = models.BigIntegerField(verbose_name='稼働時間9',validators=[MinValueValidator(0)],default=0,blank=True,null=True)    
    Machine_operate_count0 = models.BigIntegerField(verbose_name='稼働回数0',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_count1 = models.BigIntegerField(verbose_name='稼働回数1',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_count2 = models.BigIntegerField(verbose_name='稼働回数2',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_count3 = models.BigIntegerField(verbose_name='稼働回数3',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_count4 = models.BigIntegerField(verbose_name='稼働回数4',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_count5 = models.BigIntegerField(verbose_name='稼働回数5',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_count6 = models.BigIntegerField(verbose_name='稼働回数6',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_count7 = models.BigIntegerField(verbose_name='稼働回数7',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_count8 = models.BigIntegerField(verbose_name='稼働回数8',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Machine_operate_count9 = models.BigIntegerField(verbose_name='稼働回数9',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Data_datetime =  models.DateTimeField(verbose_name='データ取得日',blank=True,null=True)
    Data_date =  models.DateField(verbose_name='データ取得日（年月日）',blank=True,null=True)
    Data_time =  models.TimeField(verbose_name='データ取得日（時分秒）',blank=True,null=True)
    Machine_operating_log_input_date = models.DateField(verbose_name='登録日',blank=True,null=True)
    Machine_operating_log_memo = models.TextField(verbose_name='メモ',blank=True,null=True,max_length=50)
    Signal_sys_to_plc = models.BooleanField(default=False)
    Signal_plc_to_sys = models.BooleanField(default=False)
...
class Plc_Output_Count_Log(models.Model):
    Machine_model = models.ForeignKey(Customer_Machine,on_delete=CASCADE,verbose_name='装置')
    Plc_count_log_output0 = models.BigIntegerField(verbose_name='回数0',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output1 = models.BigIntegerField(verbose_name='回数1',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output2 = models.BigIntegerField(verbose_name='回数2',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output3 = models.BigIntegerField(verbose_name='回数3',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output4 = models.BigIntegerField(verbose_name='回数4',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output5 = models.BigIntegerField(verbose_name='回数5',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output6 = models.BigIntegerField(verbose_name='回数6',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output7 = models.BigIntegerField(verbose_name='回数7',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output8 = models.BigIntegerField(verbose_name='回数8',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output9 = models.BigIntegerField(verbose_name='回数9',validators=[MinValueValidator(0)],default=0,blank=True,null=True)

    Plc_count_log_output10 = models.BigIntegerField(verbose_name='回数10',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output11 = models.BigIntegerField(verbose_name='回数11',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output12 = models.BigIntegerField(verbose_name='回数12',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output13 = models.BigIntegerField(verbose_name='回数13',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output14 = models.BigIntegerField(verbose_name='回数14',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output15 = models.BigIntegerField(verbose_name='回数15',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output16 = models.BigIntegerField(verbose_name='回数16',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output17 = models.BigIntegerField(verbose_name='回数17',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output18 = models.BigIntegerField(verbose_name='回数18',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output19 = models.BigIntegerField(verbose_name='回数19',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    
    Plc_count_log_output20 = models.BigIntegerField(verbose_name='回数20',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output21 = models.BigIntegerField(verbose_name='回数21',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output22 = models.BigIntegerField(verbose_name='回数22',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output23 = models.BigIntegerField(verbose_name='回数23',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output24 = models.BigIntegerField(verbose_name='回数24',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output25 = models.BigIntegerField(verbose_name='回数25',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output26 = models.BigIntegerField(verbose_name='回数26',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output27 = models.BigIntegerField(verbose_name='回数27',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output28 = models.BigIntegerField(verbose_name='回数28',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output29 = models.BigIntegerField(verbose_name='回数29',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    
    Plc_count_log_output30 = models.BigIntegerField(verbose_name='回数30',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output31 = models.BigIntegerField(verbose_name='回数31',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output32 = models.BigIntegerField(verbose_name='回数32',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output33 = models.BigIntegerField(verbose_name='回数33',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output34 = models.BigIntegerField(verbose_name='回数34',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output35 = models.BigIntegerField(verbose_name='回数35',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output36 = models.BigIntegerField(verbose_name='回数36',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output37 = models.BigIntegerField(verbose_name='回数37',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output38 = models.BigIntegerField(verbose_name='回数38',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output39 = models.BigIntegerField(verbose_name='回数39',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    
    Plc_count_log_output40 = models.BigIntegerField(verbose_name='回数40',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output41 = models.BigIntegerField(verbose_name='回数41',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output42 = models.BigIntegerField(verbose_name='回数42',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output43 = models.BigIntegerField(verbose_name='回数43',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output44 = models.BigIntegerField(verbose_name='回数44',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output45 = models.BigIntegerField(verbose_name='回数45',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output46 = models.BigIntegerField(verbose_name='回数46',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output47 = models.BigIntegerField(verbose_name='回数47',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output48 = models.BigIntegerField(verbose_name='回数48',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output49 = models.BigIntegerField(verbose_name='回数49',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    
    Plc_count_log_output50 = models.BigIntegerField(verbose_name='回数50',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output51 = models.BigIntegerField(verbose_name='回数51',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output52 = models.BigIntegerField(verbose_name='回数52',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output53 = models.BigIntegerField(verbose_name='回数53',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output54 = models.BigIntegerField(verbose_name='回数54',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output55 = models.BigIntegerField(verbose_name='回数55',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output56 = models.BigIntegerField(verbose_name='回数56',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output57 = models.BigIntegerField(verbose_name='回数57',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output58 = models.BigIntegerField(verbose_name='回数58',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output59 = models.BigIntegerField(verbose_name='回数59',validators=[MinValueValidator(0)],default=0,blank=True,null=True)

    Plc_count_log_output60 = models.BigIntegerField(verbose_name='回数60',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output61 = models.BigIntegerField(verbose_name='回数61',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output62 = models.BigIntegerField(verbose_name='回数62',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
    Plc_count_log_output63 = models.BigIntegerField(verbose_name='回数63',validators=[MinValueValidator(0)],default=0,blank=True,null=True)
